...
int main(int argc, char *argv[]) {
  ...
  printf(1, "Using Mutex Lock\n");
  thread_mutex_init(&mlock);
  total_balance = 0;

  t1 = thread_create(mutex_do_work,(void*)&b1,s1);
  t2 = thread_create(mutex_do_work, (void*)&b2, s2); 
